...
VALUES
    ...
    ('34.0438', '-118.2451', 'Base Station', 'Base Station'),   
    ('34.0454', '-118.2321', 'Base Station', 'Base Station'),
    ('34.0361', '-118.2328', 'Base Station', 'Base Station'),
    ('34.0361', '-118.242', 'Base Station', 'Base Station'),
    ('34.0472', '-118.2519', 'Base Station', 'Base Station'),
    ('34.0482', '-118.2395', 'Base Station', 'Base Station'),
    ('34.0501', '-118.2446', 'LAPD Headquarters', 'Safe Zone'),
    ('34.0570', '-118.2397', 'Catholic Church', 'Safe Zone'),
    ('34.050200', '-118.2360', 'LAFD Fire Station No. 4', 'Safe Zone'),
    ('34.0376', '-118.2427', 'LAFD Post Office', 'Safe Zone'),
    ('34.0411', '-118.2479', 'LAFD Fire Station No. 9', 'Safe Zone');